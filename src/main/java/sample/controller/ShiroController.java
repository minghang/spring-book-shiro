...
public class ShiroController {
    ...
    public String testAuth1(Model model) {
        return "auth1";
    }

    @RequiresRoles("manager")
    @RequestMapping(value = "/auth2", method = RequestMethod.GET)
    public String testAuth2(Model model) {
        return "auth1";
    }

    @RequestMapping(value = "/auth3", method = RequestMethod.GET)
    public String testAuth3(Model model) {
        return "auth1";
    }


    @RequestMapping(value="/login",method=RequestMethod.POST)
    public String login(@Valid AuthUser user, BindingResult bindingResult, RedirectAttributes redirectAttributes){
